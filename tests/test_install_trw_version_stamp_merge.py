...
_FRAMEWORK_BODY = "v99.9_TRW — MODEL-AGNOSTIC ENGINEERING MEMORY FRAMEWORK\n"
_AAREF_BODY = "# AARE-F\n\n**Version**: 3.2.1\n"
...
def test_version_stamp_refresh_is_skipped_when_bodies_are_undeployed(installer_path: Path, tmp_path: Path) -> None:
    ...
    version_path.write_text("framework_version: v99.9_TRW\nregistry_digest: keep-me\n", encoding="utf-8")

    module._write_version_yaml_metadata(tmp_path)

    assert version_path.read_text(encoding="utf-8") == "framework_version: v99.9_TRW\nregistry_digest: keep-me\n"
