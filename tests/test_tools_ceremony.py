...
# -------------------------------------------------------------------------
# Ceremony state mutation wiring tests (PRD-CORE-124)
# -------------------------------------------------------------------------
...
class TestCeremonyStateMutationWiring:
    ...
    def test_session_start_calls_mark_session_started(
        ...
        # Confirm state starts at False
        state_before = read_ceremony_state(trw_dir)
        assert state_before.session_started is False

        # Patch both ceremony.py and _ceremony_helpers.py resolve_trw_dir references
        # because step_mark_session_started() lives in _ceremony_helpers and has its own import.
        with (
            patch("trw_mcp.tools.ceremony.resolve_trw_dir", return_value=trw_dir),
        ...
        # Ceremony state must reflect session_started=True
