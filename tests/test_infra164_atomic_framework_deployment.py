...
FRAMEWORK = "v99.9_TRW — MODEL-AGNOSTIC ENGINEERING MEMORY FRAMEWORK\n"
AAREF = "# AARE-F\n\n**Version**: 3.2.0\n"
...
def test_receipt_binds_canon_bodies_and_not_mutable_projections(tmp_path: Path) -> None:
    ...
    assert "framework_version: v99.9_TRW" in (tmp_path / ".trw/config.yaml").read_text(encoding="utf-8")
