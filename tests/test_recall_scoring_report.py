...
class TestSafeFloatException:
    """Cover lines 214-215: _safe_float returns 0.0 for non-numeric values."""

    def test_string_non_numeric_returns_zero(self) -> None:
        """Non-numeric string returns 0.0 (lines 214-215)."""
