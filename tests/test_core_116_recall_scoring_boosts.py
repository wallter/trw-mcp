...
class TestDomainBoost:
    ...
    def test_domain_boost_no_match(self) -> None:
        ...
        result_ctx = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3, context=ctx)
        result_no = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3)
...
class TestPhaseBoost:
    ...
    def test_phase_boost_case_insensitive(self) -> None:
        ...
        result = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3, context=ctx_lower)
        result_no = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3)
...
class TestAnchorValidity:
    ...
    def test_anchor_validity_multiplicative_half(self) -> None:
        ...
        result_full = rank_targeted_by_utility([entry_full], query_tokens=["payments"], lambda_weight=0.3, context=ctx)
        result_half = rank_targeted_by_utility([entry_half], query_tokens=["payments"], lambda_weight=0.3, context=ctx)
    ...
    def test_anchor_validity_zero(self) -> None:
        ...
        result = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3, context=ctx)
...
class TestCombinedBoosts:
    ...
    def test_all_boosts_combined(self) -> None:
        ...
        result_all = rank_targeted_by_utility([entry_all], query_tokens=["payments"], lambda_weight=0.3, context=ctx)
        result_none = rank_targeted_by_utility([entry_none], query_tokens=["payments"], lambda_weight=0.3, context=ctx)
        ...
        ranked = rank_targeted_by_utility([entry_none, entry_all], ["payments"], 0.3, context=ctx)
    ...
    def test_no_context_all_boosts_neutral(self) -> None:
        ...
        result_none = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3, context=None)
        result_omit = rank_targeted_by_utility([entry], query_tokens=["payments"], lambda_weight=0.3)
