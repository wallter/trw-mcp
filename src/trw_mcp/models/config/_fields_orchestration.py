...
class _OrchestrationFields:
    ...
    # an operator who set one is warned rather than silently ignored. max_research_waves stayed:
    # OrchestrationConfig in _sub_models.py redeclares it, so removing the flat field would
    # leave a live nested default behind.
