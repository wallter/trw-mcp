...
Contains ``cache_build_status`` for persisting build results to
``.trw/context/``, and ``persist_build_progress_state`` for the ceremony
progress projection consumed by the deliver gate.
