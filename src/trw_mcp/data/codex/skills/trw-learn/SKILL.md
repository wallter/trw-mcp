---
name: trw-learn
description: "Record, update, or retire learnings. With a summary: records a new learning. With \"resolve/obsolete L-id\": changes status. Without arguments: reflects on session memory. Use: /trw-learn [\"summary\" | resolve L-id | obsolete L-id]\n"
---
...
- Learnings with impact >= 0.7 are promoted to AGENTS.md during delivery sync
- Resolved/obsolete learnings are excluded from AGENTS.md promotion and recall results
