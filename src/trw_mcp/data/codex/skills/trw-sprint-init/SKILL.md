...
description: "Initialize an explicitly requested sprint. Lists draft PRDs, creates sprint doc, bootstraps run directory, sets up tracking. Use: /trw-sprint-init \"Sprint 16: Skills Architecture\"\n"
---
