...
description: >
  ...
  when the user explicitly asks Codex to commit current work; never auto-trigger.
---

> Codex adaptation: follow `AGENTS.md` and the current session's explicit user approvals.
