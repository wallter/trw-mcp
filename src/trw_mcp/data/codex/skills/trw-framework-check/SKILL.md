...
description: "Check TRW framework compliance. Reports ceremony adherence, phase gate status, and active run health. Use when unsure if framework obligations are being met. Use: /trw-framework-check\n"
---
...
2. **Ceremony checklist** — verify each ceremony step:
   ...
   - Is AGENTS.md auto-section current? (Read AGENTS.md, check `trw:start`/`trw:end` markers exist and have content)
