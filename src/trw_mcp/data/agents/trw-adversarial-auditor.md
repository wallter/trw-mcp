...
effort: medium
description: "Use this agent when you need a deep adversarial spec-vs-code audit covering spec compliance, type safety, DRY, error handling, observability, test quality, and integration completeness. This agent operates in waves with self-review between each phase to catch blind spots. Read-only access — it never modifies code."
model: sonnet
maxTurns: 200
memory: project
allowedTools: 
