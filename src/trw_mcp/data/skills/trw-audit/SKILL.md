...
- Read implementation code directly — tests are not a proxy for behavior
- Every finding carries a fix recommendation; a finding without one is a complaint, not an audit
