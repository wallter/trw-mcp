...
4. If explicit delegation support is unavailable, keep the plan in the main thread instead of trying to spawn background helpers.
...
Constraints:
- Do not assume provider-specific team features, background tasks, or helper panels exist.
