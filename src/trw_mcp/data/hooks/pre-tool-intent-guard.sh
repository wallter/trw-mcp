#!/bin/sh
# PRD-SEC-013-FR05: PreToolUse guard for intent-contract must_not_happen claims.
# Matcher: Write|Edit|MultiEdit
# Exit 2 = block tool call with feedback. Exit 0 = allow.
#
# METADATA ONLY: this hook NEVER executes a falsifier. A pre-write hook cannot
...
# failure — and every CATCHABLE termination signal (HUP/INT/QUIT/TERM) maps to
# the intentional exit 2 (PRD-SEC-013 R4/NFR01).
#
